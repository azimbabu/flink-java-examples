...
public class CoProcessFunctionTimers {
  public static void main(String[] args) throws Exception {
    ...
    DataStream<Tuple2<String, Long>> filterSwitches =
        env.fromElements(
    ...
    DataStream<SensorReading> forwardedReadings =
        readings
  ...
  private static class ReadingFilter
      extends CoProcessFunction<SensorReading, Tuple2<String, Long>, SensorReading> {
    ...
    public void open(Configuration parameters) throws Exception {
      forwardingEnabled =
          getRuntimeContext()
              .getState(new ValueStateDescriptor<Boolean>("filterSwitch", Types.BOOLEAN));
      disableTimer =
    ...
    public void processElement1(
        SensorReading r,
        CoProcessFunction<SensorReading, Tuple2<String, Long>, SensorReading>.Context ctx,
    ...
    public void onTimer(
        long ts,
        CoProcessFunction<SensorReading, Tuple2<String, Long>, SensorReading>.OnTimerContext ctx,
        Collector<SensorReading> out)
        throws Exception {
      // remove all state
